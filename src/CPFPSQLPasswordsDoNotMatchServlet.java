 ...
 */
@WebServlet("/CPFPSQLPasswordsDoNotMatchServlet")
public class CPFPSQLPasswordsDoNotMatchServlet extends HttpServlet {
     ...
     */
    public CPFPSQLPasswordsDoNotMatchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("We are here at the beginning of CPFPSQLPasswordsDoNotMatchServlet");
